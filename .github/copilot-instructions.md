...
- **Code tasks** → PM creates a GitHub issue and assigns a custom Copilot agent via `gh copilot suggest -p bash` (AI-powered CLI, non-interactive). See `skills/agent-coordination/SKILL.md` for the full command.
