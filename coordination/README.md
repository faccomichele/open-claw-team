...
This folder contains shared markdown files read by **all agents** in the collaborative OpenClaw team.

Every agent should load the relevant files here at the start of each session to stay in sync with the rest of the team.
